...
public class FAQParameterizedTest extends BaseTest {
    ...
    public String questionLocator; // Локатор вопроса

    @Parameterized.Parameter(1)
    public String expectedAnswerText; // Ожидаемый текст ответа
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"//div[text()='Я жизу за МКАДом, привезёте?']", "Да, обязательно. Всем самокатов! И Москве, и Московской области."},
        });
    }
    ...
    public void setUp() {
        ...
        mainPageSteps = new MainPageSteps(new pages.MainPage(driver));
    }
    ...
    public void checkFaqAnswer() {
        ...
        assertTrue("Ответ не соответствует ожидаемому для вопроса: " + questionLocator, isAnswerCorrect);
    }
}
